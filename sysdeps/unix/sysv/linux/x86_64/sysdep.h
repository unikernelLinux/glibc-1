...
#define INTERNAL_SYSCALL_NCS(number, nr, args...)			\
	internal_syscall_ndcl##nr (number, args)
...
({									\
    ...
    if(ukl_get_bypass_syscall()){					\
    	long int ukl_bp_##name(void);					\
	ukl_ss_u2k();							\
	resultvar = ukl_bp_##name();					\
	ukl_ss_k2u();							\
    } else {								\
    	asm volatile (							\
    	asmv_syscall_method \
...
({									\
    ...
    if(ukl_get_bypass_syscall()){					\
    	long int ukl_bp_##name(TYPEFY (arg1, __arg1));			\
	ukl_ss_u2k();							\
	resultvar = ukl_bp_##name(__arg1);				\
	ukl_ss_k2u();							\
    } else {								\
...
({									\
    ...
    if(ukl_get_bypass_syscall()){					\
    	long int ukl_bp_##name(TYPEFY (arg1, __arg1), ...);		\
	ukl_ss_u2k();							\
	resultvar = ukl_bp_##name(__arg1, __arg2);			\
	ukl_ss_k2u();							\
    } else {								\
...
({									\
    ...
    if(ukl_get_bypass_syscall()){					\
    	long int ukl_bp_##name(TYPEFY (arg1, __arg1), ...);		\
	ukl_ss_u2k();							\
	resultvar = ukl_bp_##name(__arg1, __arg2, __arg3);		\
	ukl_ss_k2u();							\
    } else {								\
...
({									\
    ...
    if(ukl_get_bypass_syscall()){					\
    	long int ukl_bp_##name(TYPEFY (arg1, __arg1), ...);		\
	ukl_ss_u2k();							\
	resultvar = ukl_bp_##name(__arg1, __arg2, __arg3, __arg4);	\
	ukl_ss_k2u();							\
    } else {								\
...
({									\
    ...
    if(ukl_get_bypass_syscall()){					\
    	long int ukl_bp_##name(TYPEFY (arg1, __arg1), ...);		\
	ukl_ss_u2k();							\
	resultvar = ukl_bp_##name(__arg1, __arg2, __arg3, __arg4, __arg5);	\
	ukl_ss_k2u();							\
    } else {								\
...
({									\
    ...
    if(ukl_get_bypass_syscall()){					\
    	long int ukl_bp_##name(TYPEFY (arg1, __arg1), ...);		\
	ukl_ss_u2k();							\
	resultvar = ukl_bp_##name(__arg1, __arg2, __arg3, __arg4, __arg5, __arg6);	\
	ukl_ss_k2u();							\
    } else {								\
...
#define internal_syscall_ndcl0(number, dummy...)			 \
({									\
    unsigned long int resultvar;					\
    asm volatile (							\
    asmv_syscall_method							\
...
#define internal_syscall_ndcl1(number, arg1)			 \
({									\
    unsigned long int resultvar;					\
    TYPEFY (arg1, __arg1) = ARGIFY (arg1);			 	\
    register TYPEFY (arg1, _a1) asm ("rdi") = __arg1;			\
...
#define internal_syscall_ndcl2(number, arg1, arg2)		 \
({									\
    unsigned long int resultvar;					\
    TYPEFY (arg2, __arg2) = ARGIFY (arg2);			 	\
    TYPEFY (arg1, __arg1) = ARGIFY (arg1);			 	\
...
#define internal_syscall_ndcl3(number, arg1, arg2, arg3)		 \
({									\
    unsigned long int resultvar;					\
    TYPEFY (arg3, __arg3) = ARGIFY (arg3);			 	\
    TYPEFY (arg2, __arg2) = ARGIFY (arg2);			 	\
...
#define internal_syscall_ndcl4(number, arg1, arg2, arg3, arg4) \
({									\
    unsigned long int resultvar;					\
    TYPEFY (arg4, __arg4) = ARGIFY (arg4);			 	\
    TYPEFY (arg3, __arg3) = ARGIFY (arg3);			 	\
...
#define internal_syscall_ndcl5(number, arg1, arg2, arg3, arg4, arg5) \
({									\
    unsigned long int resultvar;					\
    TYPEFY (arg5, __arg5) = ARGIFY (arg5);			 	\
    TYPEFY (arg4, __arg4) = ARGIFY (arg4);			 	\
...
#define internal_syscall_ndcl6(number, arg1, arg2, arg3, arg4, arg5, arg6) \
({									\
    unsigned long int resultvar;					\
    TYPEFY (arg6, __arg6) = ARGIFY (arg6);			 	\
    TYPEFY (arg5, __arg5) = ARGIFY (arg5);			 	\
